...
public class ProductDetails {
	...
	private int productId;
		...
		public ProductDetails(int id, int productId, String screenTechnology, String screenResolution,
				...
				String chip, String operatingSystem, String ram, String mobileNetworkSupport,
		...
		public String toString() {
			return "ProductDetails [id=" + id + ", productId=" + productId + ", screenTechnology=" + screenTechnology
					...
					+ ", chip=" + chip + ", operatingSystem=" + operatingSystem + ", ram=" + ram + ", mobileNetworkSupport=" 
					+ mobileNetworkSupport + ", wifiSupport=" + wifiSupport
